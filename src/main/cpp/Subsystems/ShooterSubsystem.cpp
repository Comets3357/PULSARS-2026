...
ShooterSubsystem::ShooterSubsystem() {
  ...
  m_shooterMotor.Configure(leader_config, rev::ResetMode::kResetSafeParameters,
  ...
  m_shooterFollower.Configure(follower_config, rev::ResetMode::kResetSafeParameters,
                          rev::PersistMode::kPersistParameters);
}
